...
\cvline{}{%Descripción
	...
	Experience as a Data Analyst at the AT\&T company, applying machine learning algorithms through Python using the ScikitLearn and Tensorflow libraries, with the purpose of 3G/4G cell classification by degradation levels; also, failure probability of each cell applying regression analysis. 
